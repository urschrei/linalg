...
The design matrix for the similarity transform is given by the following two equations:
...
The design matrix for the affine transform is given by the following two equations:
